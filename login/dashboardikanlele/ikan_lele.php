    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          ...
          <br>
          <!-- Alert Ph -->
              <?php $dataperingatan_max = mysqli_query ($conn, "SELECT * FROM tb_ph  where id_ikan = 2 and ph>8 LIMIT 1 ; ");
          ...
          <?php
           ...
           <?php $dataperingatan_min = mysqli_query ($conn, "SELECT * FROM tb_ph  where id_ikan = 2 and ph<6 LIMIT 1 ;  ");
          ...
          <?php
           ...
           <!-- Alert Tinggi Air -->
               <?php $dataperingatan_max = mysqli_query ($conn, "SELECT * FROM tb_tinggi_air  where id_ikan = 2 and tinggi_air>45  LIMIT 1 ; ");
           while ($fetch = mysqli_fetch_array($dataperingatan_max)){
             $ph_max = $fetch['nama_ikan'];
            ?>
           <div class="alert alert-danger alert-dismissible fade show" role="alert">
           ...
           <?php
            ...
            <?php $dataperingatan_min = mysqli_query ($conn, "SELECT * FROM tb_tinggi_air  where id_ikan = 2 and tinggi_air<30  LIMIT 1 ;  ");
           while ($fetch = mysqli_fetch_array($dataperingatan_min)){
             $ph_min = $fetch['nama_ikan'];
            ?>
           <div class="alert alert-warning alert-dismissible fade show" role="alert">
           ...
           <?php
            ...
            <!-- Alert Suhu Air -->
                <?php $dataperingatan_max = mysqli_query ($conn, "SELECT * FROM tb_suhu  where id_ikan = 2 and suhu>32  LIMIT 1 ; ");
            while ($fetch = mysqli_fetch_array($dataperingatan_max)){
              $ph_max = $fetch['nama_ikan'];
             ?>
            <div class="alert alert-danger alert-dismissible fade show" role="alert">
            ...
            <?php
             ...
             <?php $dataperingatan_min = mysqli_query ($conn, "SELECT * FROM tb_suhu  where id_ikan = 2 and suhu<25  LIMIT 1 ;  ");
            while ($fetch = mysqli_fetch_array($dataperingatan_min)){
              $ph_min = $fetch['nama_ikan'];
             ?>
            <div class="alert alert-warning alert-dismissible fade show" role="alert">
