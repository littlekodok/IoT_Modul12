    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          ...
          <br>
          <!-- Alert Ph -->
              <?php $dataperingatan_max = mysqli_query ($conn, "SELECT * FROM tb_ph  where id_ikan = 1 and ph>8 LIMIT 1 ; ");
          while ($fetch = mysqli_fetch_array($dataperingatan_max)){
            $ph_max = $fetch['nama_ikan'];
           ?>
          <div class="alert alert-danger alert-dismissible fade show" role="alert">
            <strong>Peringatan!</strong> <?php echo $ph_max?> Sudah melebihi batas maksimal Ph
          ...
          <?php
           ...
           <?php $dataperingatan_min = mysqli_query ($conn, "SELECT * FROM tb_ph  where id_ikan = 1 and ph<6 LIMIT 1 ;  ");
          while ($fetch = mysqli_fetch_array($dataperingatan_min)){
            $ph_min = $fetch['nama_ikan'];
           ?>
          <div class="alert alert-warning alert-dismissible fade show" role="alert">
            <strong>Peringatan!</strong> <?php echo $ph_min?> Mencapai batas minimum Ph
            <button  type="button" class="btn-close" data-dismiss="alert" aria-label="close"> </button>
          </div>
          <?php
          }
           ...
           <!-- Alert Tinggi Air -->
               <?php $dataperingatan_max = mysqli_query ($conn, "SELECT * FROM tb_tinggi_air  where id_ikan = 1 and tinggi_air>45  LIMIT 1 ; ");
           while ($fetch = mysqli_fetch_array($dataperingatan_max)){
             $ph_max = $fetch['nama_ikan'];
            ?>
           <div class="alert alert-danger alert-dismissible fade show" role="alert">
             <strong>Peringatan!</strong> Tinggi Air <?php echo $ph_max?> Sudah melebihi batas maksimal
             <button  type="button" class="btn-close" data-dismiss="alert" aria-label="close"> </button>
           </div>
           <?php
           }
            ...
            <?php $dataperingatan_min = mysqli_query ($conn, "SELECT * FROM tb_tinggi_air  where id_ikan = 1 and tinggi_air<30  LIMIT 1 ;  ");
           while ($fetch = mysqli_fetch_array($dataperingatan_min)){
             $ph_min = $fetch['nama_ikan'];
            ?>
           <div class="alert alert-warning alert-dismissible fade show" role="alert">
             <strong>Peringatan!</strong>Tinggi Air <?php echo $ph_min?> Mencapai batas minimum
             <button  type="button" class="btn-close" data-dismiss="alert" aria-label="close"> </button>
           </div>
           <?php
           }
            ...
            <!-- Alert Suhu Air -->
                <?php $dataperingatan_max = mysqli_query ($conn, "SELECT * FROM tb_suhu  where id_ikan = 1 and suhu>32  LIMIT 1 ; ");
            while ($fetch = mysqli_fetch_array($dataperingatan_max)){
              $ph_max = $fetch['nama_ikan'];
             ?>
            <div class="alert alert-danger alert-dismissible fade show" role="alert">
              <strong>Peringatan!</strong> Tinggi Air <?php echo $ph_max?> Sudah melebihi batas suhu °C
              <button  type="button" class="btn-close" data-dismiss="alert" aria-label="close"> </button>
            </div>
            <?php
            }
             ...
             <?php $dataperingatan_min = mysqli_query ($conn, "SELECT * FROM tb_suhu  where id_ikan = 1 and suhu<25  LIMIT 1 ;  ");
            while ($fetch = mysqli_fetch_array($dataperingatan_min)){
              $ph_min = $fetch['nama_ikan'];
             ?>
            <div class="alert alert-warning alert-dismissible fade show" role="alert">
              <strong>Peringatan!</strong>Suhu <?php echo $ph_min?> Mencapai batas minimum suhu °C
              <button  type="button" class="btn-close" data-dismiss="alert" aria-label="close"> </button>
            </div>
            <?php
            }
