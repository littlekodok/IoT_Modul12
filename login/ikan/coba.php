    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          ...
          <br>
          <!-- Alert Ph -->
              <?php $dataperingatan = mysqli_query ($conn, "SELECT * FROM tb_ph where id_ikan = 1 ORDER BY ph >7 DESC LIMIT 1");
          ...
          <?php
           ...
           <?php $dataperingatan = mysqli_query ($conn, "SELECT * FROM tb_ph where id_ikan = 1 ORDER BY ph <6 DESC LIMIT 1 ");
          while ($fetch = mysqli_fetch_array($dataperingatan)){
            $ph_min = $fetch['nama_ikan'];
           ?>
          <div class="alert alert-warning alert-dismissible fade show" role="alert">
            <strong>Peringatan!</strong> <?php echo $ph_min?> Belum sampai batas minimum Ph
            <button  type="button" class="btn-close" data-dismiss="alert" aria-label="close"> </button>
          </div>
          <?php
          }
